...
%     DHM = [0        0       400     inv_joint(1)*ths(1);
%         -90    25      0       inv_joint(2)*ths(2);
%         0        560     0       inv_joint(3)*ths(3)-90;
%         -90    25      515     inv_joint(4)*ths(4);
%         90     0       0       inv_joint(5)*ths(5);
%         -90    0       90     inv_joint(6)*ths(6)+180];
% 
%     alpha_i = DHM(:,1);
%     a_i = DHM(:,2);
%     d_i = DHM(:,3);
...
% 
%     if round(T_attempt, 1) == round(T_target, 1)
%     else
%         i
%         ths = Thfinal(i,:)
%         T_attempt
